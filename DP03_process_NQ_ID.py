...
def prepare_dataloader(args,split):
    ...
    instruction = 'Generate a Logical Form Relation that retrieves the information corresponding to the given question. \n'
    ...
    output_dir = 'LLMs/data_id/{}_Freebase_NQ_{}/examples.json'.format(args.dataset_type, split)
