...
def run_prediction(args,dataloader,output_dir,output_predictions=True):
    ...
    for i,pred in enumerate(dataloader):
        ...
        p8 = ''.join(predictions)
        output_list_q.append(question)
        output_list_q1.append(question + predictions[0])
        output_list_q8.append(question + p8)
        output_list_ql.append(gen_label)
    ...
    if output_predictions:
        ...
        q_file_path = os.path.join(output_dir,f'predictions_q.json')
        q1_file_path = os.path.join(output_dir,f'predictions_q1.json')
        q8_file_path = os.path.join(output_dir,f'predictions_q8.json')
        ql_file_path = os.path.join(output_dir,f'predictions_ql.json')
        ...
        dump_json(output_list_q, q_file_path, indent=4)
        dump_json(output_list_q1, q1_file_path, indent=4)
        dump_json(output_list_q8, q8_file_path, indent=4)
        dump_json(output_list_ql, ql_file_path, indent=4)
